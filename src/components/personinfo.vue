<template>
    <div id="personinfo" class="holePage">
        ...
        <div class="holeHeight" style="position:relative">
            ...
            <mt-field label="地区" v-model="value.quMc" @click.native="editArea()"></mt-field>
        ...
        <div v-if="area" style="position:absolute;width:100%;height:100%;background: #fff;top:0px;left:0px;">
